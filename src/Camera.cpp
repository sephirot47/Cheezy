...
void Camera::UpdateMatrices()
{
    ...
    mat4 R = mat4_cast(rot), T = translate(mat4(1.0f), pos);
    viewMatrix = T * R;
...
vec3  Camera::GetForward() const { return conjugate(rot) * vec3(0, 0, -1); }
vec3  Camera::GetUp() const { return conjugate(rot) * vec3(0, 1, 0); }
vec3  Camera::GetRight() const { return conjugate(rot) * vec3(1, 0, 0); }
